    ...
    <div class="row">
        ...
        <div class="col-12 col-md-12 col-lg-8">
            <div class="card table-card">
                <div class="card-body">
                    <div class="text-end p-sm-4 pb-sm-2"><a href="../application/ecom_product-add.html"
                            class="btn btn-primary"><i class="ti ti-plus f-18"></i> Add Product</a></div>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-auto pe-0"><img
                                                    src="../assets/images/application/img-prod-1.jpg" alt="user-image"
                                ...
                                <tr data-index="1">
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-auto pe-0"><img
                                                    src="../assets/images/application/img-prod-2.jpg" alt="user-image"
                                                    class="wid-40 rounded"></div>
                                            <div class="col">
